# source: https://www.daniweb.com/programming/threads/509027/sentiment-analysis-using-sentiwordnet-in-python
# try to learn how to use the sentiment lexicon
...
print("lower..............\n\n")
texts = df['text'].map(lambda Review_Text: Review_Text.lower())#..............................converting to   lower case
print(texts)
df['texts']=texts

print("Tokenisation..............\n\n")
token = df.apply(lambda row: nltk.word_tokenize(row['text']), axis=1)
