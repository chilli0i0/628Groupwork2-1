...
np.save('./features/NaiveBoW.npy', train_data_features)
...
np.save('./features/trainDataVecs.npy', trainDataVecs)
...
num_clusters=800#int(num_clusters)
...
train_centroids = np.zeros( (df.iloc[0:50000,2].size, num_clusters), \
    dtype="float32" )
...
for review in clean_train_reviews:
    train_centroids[counter] = create_bag_of_centroids( review, \
        word_centroid_map )
    counter += 1
np.save('./features/train_centroids.npy',train_centroids)
